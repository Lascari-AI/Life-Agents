...
### Denver (January–August)

- Landlord: Maplewood Properties
- Payment method: Venmo
- Monthly amount: $2,800.00
...
### Portland (September–December)

- Landlord: PDX Living LLC
- Payment method: Venmo
- Monthly amount: $3,100.00
...
**Total Internet: $1,028.00**

---

## Utilities

### Denver — Xcel Energy (January–August)
...
### Portland — PGE (September–December)
...
- Payment method: ACH from personal checking (Wells Fargo)
- Coverage: January–December 2025 (12 months)
...
Note: Also tracked separately in the Health Insurance 2025 file. Deductible as self-employed health insurance (Schedule 1, Form 1040).
